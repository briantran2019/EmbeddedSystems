...
our %config = (
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/duo-sdk/riscv64-linux-musl-x86_64/bin/riscv64-unknown-linux-musl-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  prefix => "/app/build/install_cv1800b_openssl",
  processor => "",
